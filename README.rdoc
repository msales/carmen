...
If you're in Rails:
  ...
  # classic style
  config.gem 'msales-carmen', :lib => 'carmen', :source => 'http://rubygems.org'
  
  # when using rubygems 1.3.6
  config.gem 'msales-carmen', :lib => 'carmen'
  
  # when on rails 3 put this in your Gemfile
  gem "msales-carmen", :require => "carmen"
  
Or as a plugin:

  script/plugin install git://github.com/msales/carmen
